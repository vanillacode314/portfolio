...
export default [
  {
    ...
    description: `<p>You get a <strong>6-month guarantee for bug fixes</strong>. If any issues come up in the first 6 months after signing, I'll fix them for free.</p>`,
  },
  // {
